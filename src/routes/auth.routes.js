...
// Identity Management
router.post('/identity/:userId', authMiddleware, authMiddleware, authController.issueIdentity);
router.patch('/identity/:userId', authMiddleware, authMiddleware, authController.updateIdentity);
